      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="font-display font-bold text-lg" style={{ color: '#FDF6EC' }}>
                  Brew &amp; Bloom
                </div>
                <div className="text-xs tracking-widest uppercase" style={{ color: '#C9952A', fontSize: '0.65rem' }}>
                  Café &amp; Bistro
                </div>
              </div>
            </div>
            <p className="text-sm leading-relaxed" style={{ color: '#A0856A' }}>
              A warm corner of the world where every cup tells a story. 
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-display font-semibold mb-5 tracking-wide" style={{ color: '#C9952A' }}>
              Quick Links
            </h4>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm" style={{ color: '#A0856A' }}>
              ...
              <p>📞 +880 1700-000000</p>
              <p>✉️ hello@brewandbloom.com</p>
              <div className="pt-2">
                <p className="font-semibold mb-1" style={{ color: '#E8D0A8' }}>Opening Hours</p>
        ...
        >
          <p className="text-xs" style={{ color: '#6B5040' }}>
            © 2025 Brew &amp; Bloom Café. All rights reserved.
          </p>
